...
const SUBSCRIPTION_TIERS = [
  {
    ...
    icon: Star,
    description: "A first look into what's shifting",
    features: [
      "3 predictions",
  ...
  },
  {
    ...
    icon: Zap,
    description: "Stay oriented when things are unclear",
    features: [
      "Unlimited predictions",
      "Ongoing guidance as situations unfold",
      "See patterns before they repeat",
      "Deeper readings when it matters",
      "Cancel anytime",
    ],
    popular: true,
  },
  {
    ...
    predictions: "Unlimited",
    icon: Crown,
    description: "Clarity without interruption",
    features: [
      "Everything in Plus",
      "No limits — ever",
      "Long-range perspective",
      "Priority access to new features",
      "One simple plan for the year",
    ],
  },
];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Footer */}
      <footer className="border-t border-border/50 py-8 mt-8 bg-card/30">
        <div className="container">
